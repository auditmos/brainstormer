...
- This skill runs without confirmation prompts. Do not interrupt the user mid-distillation to clarify.
- The output files are deliverables. Treat them with the same care as PRDs in `./plans/` — verbatim quotes from the source chat, no shortcuts.
